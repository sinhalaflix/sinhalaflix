 ...
 * Sinhala Cartoons, Sinhala Dubbed Movies, Sinhala Dubbed Teledramas & Sinhala Dubbed K-Dramas
 */
...
const INITIAL_CATALOG = [
  ...
  },
  {
    ...
    poster: "assets/images/banner2.jpg",
    backdrop: "assets/images/banner2.jpg",
    director: "Hiru TV Dubbing Guild",
    dubTeam: "Hiru Animation Dub",
  ...
  // ==========================================
  // SINHALA CARTOONS (SERIES)
  // ==========================================
  {
    id: "ben-10-sinhala",
    titleSinhala: "බෙන් 10 (ඔම්නිට්‍රික්ස් පිටසක්වල බලය)",
    titleEnglish: "Ben 10 (Sinhala Dubbed)",
    singlishKeywords: ["ben 10", "omnitrix", "ben tennyson", "gwen", "grandpa max", "heatblast", "four arms", "sirasa tv", "cartoon"],
    type: "series",
    category: "cartoons",
    channel: "Sirasa TV",
    year: 2005,
    ...
    tags: ["කාටූන් (Cartoon)", "සුපිරි වීර (Superhero)", "විද්‍යා ප්‍රබන්ධ (Sci-Fi)", "ක්‍රියාදාම (Action)"],
    isFeatured: true,
    trending: true,
    views: "3.6M",
    likes: "290K",
  ...
  },
  {
    ...
    titleEnglish: "Avatar: The Last Airbender (Sinhala Dubbed)",
    singlishKeywords: ["avatar the last airbender", "aang", "katara", "sokka", "zuko", "fire nation", "air nomad", "sirasa tv", "cartoon"],
    type: "series",
    category: "cartoons",
    channel: "Sirasa TV",
    year: 2007,
    ...
    tags: ["කාටූන් (Cartoon)", "ඇනිමේ (Anime)", "වික්‍රමාන්විත (Adventure)", "ක්‍රියාදාම (Action)"],
    isFeatured: false,
    trending: true,
    views: "2.9M",
    likes: "245K",
  ...
  },
  {
    ...
    singlishKeywords: ["tintin", "snowy", "captain haddock", "thomson and thompson", "sirasa tv", "rupavahini", "cartoon"],
    type: "series",
    category: "cartoons",
    channel: "Sirasa TV",
    year: 1992,
    ...
    tags: ["කාටූන් (Cartoon)", "අභිරහස් (Mystery)", "වික්‍රමාන්විත (Adventure)"],
    isFeatured: false,
    trending: false,
    views: "1.7M",
    likes: "112K",
